function [dl8,Opt]=mhit_get_DL8(discharge,wYear,wYearList,Opt)
...
%% calculating mh14
minRolling7DayMeanByWYear=arrayfun(@(wyID) min(Opt.rolling7DayMeanByWYear{wyID}),(1:numel(Opt.rolling7DayMeanByWYear))');
dl8=std(minRolling7DayMeanByWYear)./mean(minRolling7DayMeanByWYear)*100;
end
