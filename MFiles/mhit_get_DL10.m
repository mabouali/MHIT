function [dl10,Opt]=mhit_get_DL10(discharge,wYear,wYearList,Opt)
...
%% calculating mh14
minRolling90DayMeanByWYear=arrayfun(@(wyID) min(Opt.rolling90DayMeanByWYear{wyID}),(1:numel(Opt.rolling90DayMeanByWYear))');
dl10=std(minRolling90DayMeanByWYear)./mean(minRolling90DayMeanByWYear)*100;
end
