function [dh22,Opt]=mhit_get_DH22(discharge,wYear,jDay,wYearList,Opt)
...
medianEventDurationByYear=zeros(numel(wYearList),1);
for wyID=1:numel(wYearList)
  ...
  medianEventDurationByYear(wyID)=nanmedian(eventsDuration);
end

dh22=Opt.prefFun(medianEventDurationByYear);
end
